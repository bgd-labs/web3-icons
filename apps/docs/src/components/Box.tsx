...
export const Box = ({ children }: BoxProps) => {
  return (
    <div className="relative overflow-hidden pb-[10px] pl-[10px]">
      ...
      <div className="z-2 border-b-main-100 absolute bottom-[-6px] right-[-25px] h-0 w-0 border-b-[30px] border-l-[20px] border-r-[20px] border-l-transparent border-r-transparent" />
