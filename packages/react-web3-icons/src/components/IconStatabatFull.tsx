...
const IconStatabatFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#statabat__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statabat__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statabat__basicattentiontoken__clip0_292_125)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="statabat__basicattentiontoken__clip0_292_125">
    ...
    <defs>
      <linearGradient
        id="statabat__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statabat__circleClip">
