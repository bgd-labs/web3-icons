...
const IconStataraiMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statarai__circleClip)">
      ...
      >
        <g clipPath="url(#statarai__raireflexindex__clip0_298_429)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statarai__raireflexindex__clip0_298_429">
...
export default IconStataraiMono;
