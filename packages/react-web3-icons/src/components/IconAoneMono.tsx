...
const IconAoneMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#sjsag__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#sjsag__zk2jri__clip0_298_374)">
        ...
        <defs>
          <clipPath id="sjsag__zk2jri__clip0_298_374">
