...
const IconAoneMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#02xct__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#02xct__2gnk__clip0_298_374)">
        ...
        <defs>
          <clipPath id="02xct__2gnk__clip0_298_374">
