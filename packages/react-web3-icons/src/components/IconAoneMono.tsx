...
const IconAoneMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#rfrnd__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#rfrnd__9nuo4__clip0_298_374)">
        ...
        <defs>
          <clipPath id="rfrnd__9nuo4__clip0_298_374">
