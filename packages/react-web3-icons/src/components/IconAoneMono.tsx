...
const IconAoneMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#zd12rj__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#zd12rj__r497r__clip0_298_374)">
        ...
        <defs>
          <clipPath id="zd12rj__r497r__clip0_298_374">
    ...
    <defs>
      <clipPath id="zd12rj__circleClip">
