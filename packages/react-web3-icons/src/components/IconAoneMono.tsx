...
const IconAoneMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#dj2uy__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#dj2uy__t4uu2__clip0_298_374)">
        ...
        <defs>
          <clipPath id="dj2uy__t4uu2__clip0_298_374">
