...
const IconAzrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#3ho8n__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#3ho8n__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#3ho8n__k4u3y__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="3ho8n__k4u3y__clip0_298_476">
