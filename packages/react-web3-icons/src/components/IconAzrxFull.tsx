...
const IconAzrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#278bm__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#278bm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#278bm__mr73g__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="278bm__mr73g__clip0_298_476">
