...
const IconAzrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#y6hvz__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#y6hvz__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#y6hvz__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="y6hvz__clip0_298_476">
