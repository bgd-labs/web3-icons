...
const IconAzrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#azrx__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#azrx__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#azrx__0xcoin__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="azrx__0xcoin__clip0_298_476">
