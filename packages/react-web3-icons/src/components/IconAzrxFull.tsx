...
const IconAzrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#9l43r__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#9l43r__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#9l43r__m4391__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="9l43r__m4391__clip0_298_476">
