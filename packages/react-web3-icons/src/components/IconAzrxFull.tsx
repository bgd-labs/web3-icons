...
const IconAzrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#0xcoin__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#0xcoin__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#0xcoin__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="0xcoin__clip0_298_476">
    ...
    <defs>
      <linearGradient
        id="0xcoin__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="0xcoin__circleClip">
