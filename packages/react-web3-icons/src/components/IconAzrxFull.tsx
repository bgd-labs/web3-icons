...
const IconAzrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#b4jgy__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#b4jgy__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#b4jgy__jo0hx__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="b4jgy__jo0hx__clip0_298_476">
