...
const IconStatausdbcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#statausdbc__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statausdbc__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statausdbc__usdbasecoin__clip0_298_901)">
          <path
            fill="#2151F4"
        ...
        <defs>
          <clipPath id="statausdbc__usdbasecoin__clip0_298_901">
    ...
    <defs>
      <linearGradient
        id="statausdbc__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statausdbc__circleClip">
