...
const IconAjeurMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#guk4c__circleClip)">
      <g
        fill="currentColor"
        style={{
