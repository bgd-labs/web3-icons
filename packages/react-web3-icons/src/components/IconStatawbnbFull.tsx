...
const IconStatawbnbFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#ffvcn__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#ffvcn__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#ffvcn__7spml__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="ffvcn__7spml__clip0_292_152">
