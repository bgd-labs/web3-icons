...
const IconStatawbnbFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#5rp6o__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#5rp6o__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#5rp6o__lmnv6i__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="5rp6o__lmnv6i__clip0_292_152">
