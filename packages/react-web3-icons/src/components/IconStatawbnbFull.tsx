...
const IconStatawbnbFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#qd9gkg__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#qd9gkg__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#qd9gkg__a71zf__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="qd9gkg__a71zf__clip0_292_152">
    ...
    <defs>
      ...
      <clipPath id="qd9gkg__circleClip">
