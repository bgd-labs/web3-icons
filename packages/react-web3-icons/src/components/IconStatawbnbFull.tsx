...
const IconStatawbnbFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statawbnb__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statawbnb__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statawbnb__bnbsmartchain__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="statawbnb__bnbsmartchain__clip0_292_152">
    ...
    <defs>
      <linearGradient
        id="statawbnb__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statawbnb__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatawbnbFull;
