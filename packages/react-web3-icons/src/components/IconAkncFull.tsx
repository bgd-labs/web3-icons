...
const IconAkncFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#d5nj2__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#d5nj2__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#d5nj2__o29zv__clip0_294_256)">
          <path
            fill="#31CB9E"
        ...
        <defs>
          <clipPath id="d5nj2__o29zv__clip0_294_256">
