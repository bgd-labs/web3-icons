...
const IconAkncFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#dcod3__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#dcod3__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#dcod3__e2ru8__clip0_294_256)">
          <path
            fill="#31CB9E"
        ...
        <defs>
          <clipPath id="dcod3__e2ru8__clip0_294_256">
