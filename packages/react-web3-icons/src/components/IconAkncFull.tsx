...
const IconAkncFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#aknc__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#aknc__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#aknc__kybernetworkcrystalv2__clip0_294_256)">
          <path
            fill="#31CB9E"
        ...
        <defs>
          <clipPath id="aknc__kybernetworkcrystalv2__clip0_294_256">
