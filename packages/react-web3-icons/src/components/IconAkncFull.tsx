...
const IconAkncFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#btz9z__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#btz9z__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#btz9z__49fkk__clip0_294_256)">
          <path
            fill="#31CB9E"
        ...
        <defs>
          <clipPath id="btz9z__49fkk__clip0_294_256">
