...
const IconAkncFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#25qz1__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#25qz1__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#25qz1__sjaae__clip0_294_256)">
          <path
            fill="#31CB9E"
        ...
        <defs>
          <clipPath id="25qz1__sjaae__clip0_294_256">
