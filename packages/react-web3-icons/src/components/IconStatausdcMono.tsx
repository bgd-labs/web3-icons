...
const IconStatausdcMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#xxt9oi__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#xxt9oi__hltd3__clip0_298_783)">
        ...
        <defs>
          <clipPath id="xxt9oi__hltd3__clip0_298_783">
    ...
    <defs>
      <clipPath id="xxt9oi__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatausdcMono;
