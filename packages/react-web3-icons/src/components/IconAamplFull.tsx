...
const IconAamplFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#throo__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#throo__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#throo__7mp1r__clip0_292_102)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="throo__7mp1r__clip0_292_102">
