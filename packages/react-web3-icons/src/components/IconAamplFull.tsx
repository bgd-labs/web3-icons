...
const IconAamplFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#azc5d__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#azc5d__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#azc5d__9fxai__clip0_292_102)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="azc5d__9fxai__clip0_292_102">
