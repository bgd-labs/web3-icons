...
const IconAamplFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#mnq5n__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#mnq5n__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#mnq5n__clip0_292_102)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="mnq5n__clip0_292_102">
