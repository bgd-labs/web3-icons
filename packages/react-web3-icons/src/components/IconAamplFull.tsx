...
const IconAamplFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#pt4me__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#pt4me__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#pt4me__6fhny__clip0_292_102)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="pt4me__6fhny__clip0_292_102">
