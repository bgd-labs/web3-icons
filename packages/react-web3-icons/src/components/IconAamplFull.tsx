...
const IconAamplFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#aampl__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#aampl__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#aampl__ampleforth__clip0_292_102)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="aampl__ampleforth__clip0_292_102">
