...
const IconAfraxMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#c1740k__circleClip)">
      <g
        fill="currentColor"
        style={{
      ...
      >
        <path d="M19.04 11.66a5.2 5.2 0 0 0-2.43-.93 5.16 5.16 0 0 0-5.22 2.82c-.24.49-.37.85-.47 1.34-.1.5-.1 1.44 0 1.95.32 1.59 1.32 2.92 2.74 3.64 1.96 1 4.29.66 5.91-.84a5.17 5.17 0 0 0 .67-6.78c-.26-.38-.83-.94-1.2-1.2" />
    ...
    <defs>
      <clipPath id="c1740k__circleClip">
