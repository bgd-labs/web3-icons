...
const IconStataenjFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#stataenj__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataenj__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataenj__enjincoin__clip0_294_3414)">
          <path
            fill="#7567CD"
        ...
        <defs>
          <clipPath id="stataenj__enjincoin__clip0_294_3414">
    ...
    <defs>
      <linearGradient
        id="stataenj__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataenj__circleClip">
