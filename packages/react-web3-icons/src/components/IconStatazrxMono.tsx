...
const IconStatazrxMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statazrx__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statazrx__0xcoin__clip0_298_474)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statazrx__0xcoin__clip0_298_474">
    ...
    <defs>
      <clipPath id="statazrx__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatazrxMono;
