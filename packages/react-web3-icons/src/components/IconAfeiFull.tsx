...
const IconAfeiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#arsq3__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#arsq3__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#arsq3__uo5zx__clip0_292_219)">
          <path
            fill="#22996E"
        ...
        <defs>
          <clipPath id="arsq3__uo5zx__clip0_292_219">
