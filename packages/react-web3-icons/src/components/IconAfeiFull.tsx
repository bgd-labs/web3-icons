...
const IconAfeiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#cogyk__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#cogyk__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#cogyk__zufrzk__clip0_292_219)">
          <path
            fill="#22996E"
        ...
        <defs>
          <clipPath id="cogyk__zufrzk__clip0_292_219">
