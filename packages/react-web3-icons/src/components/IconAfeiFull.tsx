...
const IconAfeiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#xx16wj__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#xx16wj__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#xx16wj__40znil__clip0_292_219)">
          <path
            fill="#22996E"
        ...
        <defs>
          <clipPath id="xx16wj__40znil__clip0_292_219">
    ...
    <defs>
      <linearGradient
        id="xx16wj__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="xx16wj__circleClip">
