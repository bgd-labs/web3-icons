...
const IconAldoFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#nulj6__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#nulj6__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#nulj6__clip0_297_35)">
          <path
            fill="#F69988"
        ...
        <defs>
          <clipPath id="nulj6__clip0_297_35">
