...
const IconAldoFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#aldo__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#aldo__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#aldo__lidodaotoken__clip0_297_35)">
          <path
            fill="#F69988"
        ...
        <defs>
          <clipPath id="aldo__lidodaotoken__clip0_297_35">
