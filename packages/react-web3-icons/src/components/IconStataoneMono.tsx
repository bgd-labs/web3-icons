...
const IconStataoneMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#77qjd__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#77qjd__t4uu2__clip0_298_374)">
        ...
        <defs>
          <clipPath id="77qjd__t4uu2__clip0_298_374">
    ...
    <defs>
      <clipPath id="77qjd__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStataoneMono;
