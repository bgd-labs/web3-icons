...
const IconStataoneMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#1hmkbl__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#1hmkbl__clip0_298_374)">
        ...
        <defs>
          <clipPath id="1hmkbl__clip0_298_374">
    ...
    <defs>
      <clipPath id="1hmkbl__circleClip">
