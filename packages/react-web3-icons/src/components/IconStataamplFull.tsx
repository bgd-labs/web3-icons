...
const IconStataamplFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#stataampl__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataampl__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataampl__ampleforth__clip0_292_102)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="stataampl__ampleforth__clip0_292_102">
    ...
    <defs>
      <linearGradient
        id="stataampl__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataampl__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStataamplFull;
