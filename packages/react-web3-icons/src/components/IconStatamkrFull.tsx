...
const IconStatamkrFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#l25rg__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#l25rg__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#l25rg__clip0_298_619)">
          <path
            fill="#58B89C"
        ...
        <defs>
          <clipPath id="l25rg__clip0_298_619">
