...
const IconStatamkrFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statamkr__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statamkr__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statamkr__maker__clip0_298_619)">
          <path
            fill="#58B89C"
        ...
        <defs>
          <clipPath id="statamkr__maker__clip0_298_619">
    ...
    <defs>
      <linearGradient
        id="statamkr__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statamkr__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatamkrFull;
