...
const IconAjeurFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#fion2__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#fion2__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#fion2__xhjn9__clip0_294_241)">
          <path
            fill="#FC0"
        ...
        <defs>
          <clipPath id="fion2__xhjn9__clip0_294_241">
