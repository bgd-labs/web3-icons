...
const IconAjeurFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#ajeur__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#ajeur__circleClip)">
      ...
      >
        <g clipPath="url(#ajeur__jarvissyntheticeuro__clip0_294_241)">
          <path
            fill="#FC0"
        ...
        <defs>
          <clipPath id="ajeur__jarvissyntheticeuro__clip0_294_241">
