...
const IconAjeurFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#px0k1__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#px0k1__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#px0k1__ff4tsk__clip0_294_241)">
          <path
            fill="#FC0"
        ...
        <defs>
          <clipPath id="px0k1__ff4tsk__clip0_294_241">
