...
const IconAjeurFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#5rpxm__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#5rpxm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#5rpxm__y7kdp__clip0_294_241)">
          <path
            fill="#FC0"
        ...
        <defs>
          <clipPath id="5rpxm__y7kdp__clip0_294_241">
