...
const IconAensFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#g3y1if__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#g3y1if__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#g3y1if__073h3__clip0_294_308)">
          <path
            fill="url(#g3y1if__073h3__paint0_linear_294_308)"
        ...
        <defs>
          <linearGradient
            id="g3y1if__073h3__paint0_linear_294_308"
            x1={25.787}
            x2={-5.306}
            y1={33.249}
            y2={-21.498}
          ...
          <clipPath id="g3y1if__073h3__clip0_294_308">
    ...
    <defs>
      <linearGradient
        id="g3y1if__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="g3y1if__circleClip">
