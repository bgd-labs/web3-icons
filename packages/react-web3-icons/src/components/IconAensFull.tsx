...
const IconAensFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#7slt8__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#7slt8__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#7slt8__naqrx__clip0_294_308)">
          <path
            fill="url(#7slt8__naqrx__paint0_linear_294_308)"
        ...
        <defs>
          <linearGradient
            id="7slt8__naqrx__paint0_linear_294_308"
            x1={25.787}
            x2={-5.306}
            y1={33.249}
            y2={-21.498}
          ...
          <clipPath id="7slt8__naqrx__clip0_294_308">
