...
const IconAbusdFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#abusd__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#abusd__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#abusd__busd__clip0_292_114)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="abusd__busd__clip0_292_114">
