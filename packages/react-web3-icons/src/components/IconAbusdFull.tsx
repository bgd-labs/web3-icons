...
const IconAbusdFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#cy9t3__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#cy9t3__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#cy9t3__yp8thf__clip0_292_114)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="cy9t3__yp8thf__clip0_292_114">
