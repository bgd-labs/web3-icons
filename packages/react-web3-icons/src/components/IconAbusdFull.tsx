...
const IconAbusdFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#efgzj__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#efgzj__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#efgzj__pd7ck__clip0_292_114)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="efgzj__pd7ck__clip0_292_114">
