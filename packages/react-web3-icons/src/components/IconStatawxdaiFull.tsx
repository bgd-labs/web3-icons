...
const IconStatawxdaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#statawxdai__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statawxdai__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statawxdai__wrappedxdai__clip0_297_211)">
          <path
            fill="#12326C"
        ...
        <defs>
          <clipPath id="statawxdai__wrappedxdai__clip0_297_211">
    ...
    <defs>
      <linearGradient
        id="statawxdai__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statawxdai__circleClip">
