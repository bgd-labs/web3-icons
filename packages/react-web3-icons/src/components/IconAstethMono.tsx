...
const IconAstethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#b6enl__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#b6enl__hybja__clip0_298_543)">
        ...
        <defs>
          <clipPath id="b6enl__hybja__clip0_298_543">
