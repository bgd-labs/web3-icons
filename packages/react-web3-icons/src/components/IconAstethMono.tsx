...
const IconAstethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#l72vi__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#l72vi__nrkzf__clip0_298_543)">
        ...
        <defs>
          <clipPath id="l72vi__nrkzf__clip0_298_543">
