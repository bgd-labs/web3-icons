...
const IconAstethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#lidostakedether__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#lidostakedether__clip0_298_543)">
          <path d="m21.3 16.46-5.31 3.13-5.3-3.13 5.3 9.66zm-9.7-3.23 4.41 2.56 4.41-2.54L16 10.81z" />
        ...
        <defs>
          <clipPath id="lidostakedether__clip0_298_543">
    ...
    <defs>
      <clipPath id="lidostakedether__circleClip">
