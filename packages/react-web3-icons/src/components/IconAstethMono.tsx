...
const IconAstethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#itvwv__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#itvwv__0kz42__clip0_298_543)">
        ...
        <defs>
          <clipPath id="itvwv__0kz42__clip0_298_543">
