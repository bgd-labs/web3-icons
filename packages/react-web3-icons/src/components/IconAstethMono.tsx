...
const IconAstethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#tjs1of__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#tjs1of__w3xjt__clip0_298_543)">
        ...
        <defs>
          <clipPath id="tjs1of__w3xjt__clip0_298_543">
    ...
    <defs>
      <clipPath id="tjs1of__circleClip">
