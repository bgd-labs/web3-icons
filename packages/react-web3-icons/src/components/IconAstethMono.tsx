...
const IconAstethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#asteth__circleClip)">
      <g
        style={{
      ...
      >
        <g
          fill="currentColor"
          clipPath="url(#asteth__lidostakedether__clip0_298_543)"
        >
        ...
        <defs>
          <clipPath id="asteth__lidostakedether__clip0_298_543">
    ...
    <defs>
      <clipPath id="asteth__circleClip">
