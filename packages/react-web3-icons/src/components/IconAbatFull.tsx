...
const IconAbatFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#fpd6e__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#fpd6e__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#fpd6e__d7uov__clip0_292_125)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="fpd6e__d7uov__clip0_292_125">
