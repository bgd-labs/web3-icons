...
const IconAbatFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#kbwhi__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#kbwhi__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#kbwhi__aa0g8__clip0_292_125)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="kbwhi__aa0g8__clip0_292_125">
