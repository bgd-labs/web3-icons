...
const IconAbatFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#abat__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#abat__circleClip)">
      ...
      >
        <g clipPath="url(#abat__basicattentiontoken__clip0_292_125)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="abat__basicattentiontoken__clip0_292_125">
