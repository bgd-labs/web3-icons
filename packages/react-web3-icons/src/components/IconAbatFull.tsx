...
const IconAbatFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#basicattentiontoken__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#basicattentiontoken__circleClip)">
      ...
      >
        <g clipPath="url(#basicattentiontoken__clip0_292_125)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="basicattentiontoken__clip0_292_125">
    ...
    <defs>
      <linearGradient
        id="basicattentiontoken__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
