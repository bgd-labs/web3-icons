...
const IconAbatFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#8xuqm__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#8xuqm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#8xuqm__8o39h__clip0_292_125)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="8xuqm__8o39h__clip0_292_125">
