...
const IconStatatribeFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#6be0l__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#6be0l__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#6be0l__hxtdu__clip0_298_930)">
          <path
            fill="#428AC9"
        ...
        <defs>
          <clipPath id="6be0l__hxtdu__clip0_298_930">
