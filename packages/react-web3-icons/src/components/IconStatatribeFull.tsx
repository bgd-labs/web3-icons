...
const IconStatatribeFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statatribe__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statatribe__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statatribe__tribe__clip0_298_930)">
          <path
            fill="#428AC9"
        ...
        <defs>
          <clipPath id="statatribe__tribe__clip0_298_930">
    ...
    <defs>
      <linearGradient
        id="statatribe__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statatribe__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatatribeFull;
