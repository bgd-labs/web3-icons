...
const IconStatazrxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#f6jgaf__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#f6jgaf__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#f6jgaf__jo0hx__clip0_298_476)">
          <path
            fill="#2F2C2C"
        ...
        <defs>
          <clipPath id="f6jgaf__jo0hx__clip0_298_476">
    ...
    <defs>
      ...
      <clipPath id="f6jgaf__circleClip">
