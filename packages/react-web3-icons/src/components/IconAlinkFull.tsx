...
const IconAlinkFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#odkbh__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#odkbh__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#odkbh__0dzux__clip0_297_158)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="odkbh__0dzux__clip0_297_158">
