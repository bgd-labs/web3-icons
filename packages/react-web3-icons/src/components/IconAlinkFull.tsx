...
const IconAlinkFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#fci6d__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#fci6d__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#fci6d__ka59q__clip0_297_158)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="fci6d__ka59q__clip0_297_158">
