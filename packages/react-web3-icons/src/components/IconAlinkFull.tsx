...
const IconAlinkFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#alink__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#alink__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#alink__chainlink__clip0_297_158)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="alink__chainlink__clip0_297_158">
