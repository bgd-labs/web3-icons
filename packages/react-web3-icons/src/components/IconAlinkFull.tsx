...
const IconAlinkFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#3p7d4__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#3p7d4__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#3p7d4__sandt__clip0_297_158)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="3p7d4__sandt__clip0_297_158">
