...
const IconAsdaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#7sita__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#7sita__egpug__clip0_298_390)">
        ...
        <defs>
          <clipPath id="7sita__egpug__clip0_298_390">
