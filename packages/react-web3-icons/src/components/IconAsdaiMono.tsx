...
const IconAsdaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#asdai__circleClip)">
      <g
        style={{
      ...
      >
        <g
          fill="currentColor"
          clipPath="url(#asdai__savingsdai__clip0_298_390)"
        >
        ...
        <defs>
          <clipPath id="asdai__savingsdai__clip0_298_390">
