...
const IconAsdaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#lc1ec__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#lc1ec__w876j__clip0_298_390)">
        ...
        <defs>
          <clipPath id="lc1ec__w876j__clip0_298_390">
