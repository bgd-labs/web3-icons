...
const IconAsdaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#3141jj__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#3141jj__z2p8t__clip0_298_390)">
        ...
        <defs>
          <clipPath id="3141jj__z2p8t__clip0_298_390">
    ...
    <defs>
      <clipPath id="3141jj__circleClip">
