...
const IconAsdaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#02w6p__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#02w6p__2ayw8__clip0_298_390)">
        ...
        <defs>
          <clipPath id="02w6p__2ayw8__clip0_298_390">
