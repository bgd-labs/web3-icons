...
const IconAsdaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#8kkt8__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#8kkt8__741ag__clip0_298_390)">
        ...
        <defs>
          <clipPath id="8kkt8__741ag__clip0_298_390">
