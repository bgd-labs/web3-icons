...
const IconArenFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#aren__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#aren__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#aren__republictoken__clip0_298_750)">
          <path
            fill="#183055"
    ...
    <defs>
      ...
      <clipPath id="aren__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconArenFull;
