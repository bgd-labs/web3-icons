...
const IconStataopMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#b1p7qg__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#b1p7qg__rrr62f__clip0_298_720)">
          <path d="M21.36 13.4h-1.44l-.46 2.15h1.38c.34 0 .63-.09.88-.28.26-.18.42-.45.5-.79.02-.14.04-.26.04-.36 0-.23-.07-.41-.2-.53-.14-.13-.37-.19-.7-.19m-8.7-.06c-.45 0-.83.13-1.15.4-.31.26-.54.67-.67 1.21-.14.54-.29 1.19-.43 1.97-.03.16-.05.33-.05.5 0 .74.38 1.1 1.15 1.1.45 0 .83-.13 1.14-.4.32-.26.55-.67.68-1.21.18-.75.32-1.41.42-1.97.03-.17.05-.34.05-.52 0-.73-.38-1.09-1.14-1.09z" />
        ...
        <defs>
          <clipPath id="b1p7qg__rrr62f__clip0_298_720">
    ...
    <defs>
      <clipPath id="b1p7qg__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStataopMono;
