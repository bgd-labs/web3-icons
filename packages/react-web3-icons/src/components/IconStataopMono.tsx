...
const IconStataopMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataop__circleClip)">
      <g
        style={{
      ...
      >
        <g
          fill="currentColor"
          clipPath="url(#stataop__opmainnet__clip0_298_720)"
        >
        ...
        <defs>
          <clipPath id="stataop__opmainnet__clip0_298_720">
    ...
    <defs>
      <clipPath id="stataop__circleClip">
