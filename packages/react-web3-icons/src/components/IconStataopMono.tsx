...
const IconStataopMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#5s0eyl__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#5s0eyl__boii3__clip0_298_720)">
        ...
        <defs>
          <clipPath id="5s0eyl__boii3__clip0_298_720">
    ...
    <defs>
      <clipPath id="5s0eyl__circleClip">
