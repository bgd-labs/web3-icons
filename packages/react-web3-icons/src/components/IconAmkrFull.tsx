...
const IconAmkrFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#ir88g__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#ir88g__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#ir88g__clip0_298_619)">
          <path
            fill="#58B89C"
        ...
        <defs>
          <clipPath id="ir88g__clip0_298_619">
