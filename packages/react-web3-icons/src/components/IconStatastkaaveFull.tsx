...
const IconStatastkaaveFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statastkaave__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statastkaave__circleClip)">
      <g
        style={{
    ...
    <defs>
      <linearGradient
        id="statastkaave__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statastkaave__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatastkaaveFull;
