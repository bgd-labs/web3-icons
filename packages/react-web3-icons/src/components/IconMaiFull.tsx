...
const IconMaiFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#mai(mimatic)__clip0_298_258)">
      <path
        fill="url(#mai(mimatic)__paint0_linear_298_258)"
        d="M16 32c8.837 0 16-7.163 16-16S24.837 0 16 0 0 7.163 0 16s7.163 16 16 16"
      />
      <path
        stroke="url(#mai(mimatic)__paint1_linear_298_258)"
    ...
    <defs>
      <linearGradient
        id="mai(mimatic)__paint0_linear_298_258"
        x1={16.002}
        x2={16.002}
        y1={0.004}
        y2={32.004}
      ...
      <linearGradient
        id="mai(mimatic)__paint1_linear_298_258"
        x1={16.002}
        x2={16.002}
        y1={2.756}
        y2={29.239}
      ...
      <clipPath id="mai(mimatic)__clip0_298_258">
