...
const IconAmetisFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#metis__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#metis__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#metis__clip0_423_210)">
          <path
            fill="#00DACC"
        ...
        <defs>
          <clipPath id="metis__clip0_423_210">
