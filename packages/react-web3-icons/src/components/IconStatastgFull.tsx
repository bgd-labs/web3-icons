...
const IconStatastgFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#statastg__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statastg__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statastg__stargatetoken__clip0_298_1022)">
          <path
            fill="#000"
    ...
    <defs>
      <linearGradient
        id="statastg__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
