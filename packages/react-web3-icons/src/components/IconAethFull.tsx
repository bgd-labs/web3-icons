...
const IconAethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#y818dk__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#y818dk__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#y818dk__4z7yxk__clip0_294_3463)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="y818dk__4z7yxk__clip0_294_3463">
    ...
    <defs>
      <linearGradient
        id="y818dk__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="y818dk__circleClip">
