...
const IconAethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#aeth__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#aeth__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#aeth__ethereum__clip0_294_3463)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="aeth__ethereum__clip0_294_3463">
