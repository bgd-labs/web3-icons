...
const IconAethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#ethereum__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#ethereum__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#ethereum__clip0_294_3463)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="ethereum__clip0_294_3463">
    ...
    <defs>
      <linearGradient
        id="ethereum__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="ethereum__circleClip">
