...
const IconAethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#xqs9f__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#xqs9f__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#xqs9f__q84z__clip0_294_3463)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="xqs9f__q84z__clip0_294_3463">
