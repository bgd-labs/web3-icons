...
const IconAfraxFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#afrax__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#afrax__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#afrax__frax__clip0_294_3448)">
          <path
            fill="#000"
        ...
        <defs>
          <clipPath id="afrax__frax__clip0_294_3448">
