...
const IconAsdMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#aiinqh__circleClip)">
      <g
        style={{
    ...
    <defs>
      <clipPath id="aiinqh__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconAsdMono;
