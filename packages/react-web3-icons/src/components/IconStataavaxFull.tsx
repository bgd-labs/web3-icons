...
const IconStataavaxFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#stataavax__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataavax__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataavax__avalanche__clip0_292_172)">
          <path
            fill="#E84142"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="stataavax__avalanche__clip0_292_172">
    ...
    <defs>
      <linearGradient
        id="stataavax__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataavax__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStataavaxFull;
