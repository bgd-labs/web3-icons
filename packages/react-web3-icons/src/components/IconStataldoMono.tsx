...
const IconStataldoMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#hq1nc__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#hq1nc__ftqhd__clip0_297_32)">
        ...
        <defs>
          <clipPath id="hq1nc__ftqhd__clip0_297_32">
