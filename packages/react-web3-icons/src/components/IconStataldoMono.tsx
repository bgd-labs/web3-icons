...
const IconStataldoMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#rl87x__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#rl87x__33sf__clip0_297_32)">
        ...
        <defs>
          <clipPath id="rl87x__33sf__clip0_297_32">
