...
const IconStatamaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#6hfwvg__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#6hfwvg__clip0_298_256)">
        ...
        <defs>
          <clipPath id="6hfwvg__clip0_298_256">
    ...
    <defs>
      <clipPath id="6hfwvg__circleClip">
