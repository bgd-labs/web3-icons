...
const IconStatamaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#zfnzn__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#zfnzn__kgtv__clip0_298_256)">
        ...
        <defs>
          <clipPath id="zfnzn__kgtv__clip0_298_256">
