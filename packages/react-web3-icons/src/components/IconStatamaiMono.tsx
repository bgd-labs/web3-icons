...
const IconStatamaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#p408d__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#p408d__bem6f__clip0_298_256)">
        ...
        <defs>
          <clipPath id="p408d__bem6f__clip0_298_256">
