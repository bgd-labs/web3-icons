...
const IconStatamaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#ii6se__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#ii6se__zjdn8i__clip0_298_256)">
        ...
        <defs>
          <clipPath id="ii6se__zjdn8i__clip0_298_256">
