...
const IconStatamaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#dr4ch__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#dr4ch__zzxpg__clip0_298_256)">
        ...
        <defs>
          <clipPath id="dr4ch__zzxpg__clip0_298_256">
