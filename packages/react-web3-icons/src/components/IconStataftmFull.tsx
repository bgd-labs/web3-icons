...
const IconStataftmFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#stataftm__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataftm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataftm__fantom__clip0_294_3389)">
          <path
            fill="#1969FF"
        ...
        <defs>
          <clipPath id="stataftm__fantom__clip0_294_3389">
    ...
    <defs>
      <linearGradient
        id="stataftm__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataftm__circleClip">
