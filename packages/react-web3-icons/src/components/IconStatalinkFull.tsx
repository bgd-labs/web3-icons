...
const IconStatalinkFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statalink__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statalink__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statalink__chainlink__clip0_297_158)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="statalink__chainlink__clip0_297_158">
    ...
    <defs>
      <linearGradient
        id="statalink__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statalink__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatalinkFull;
