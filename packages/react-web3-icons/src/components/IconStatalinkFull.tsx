...
const IconStatalinkFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#9u1dj__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#9u1dj__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#9u1dj__0dzux__clip0_297_158)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="9u1dj__0dzux__clip0_297_158">
