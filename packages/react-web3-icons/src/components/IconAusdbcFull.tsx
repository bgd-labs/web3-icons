...
const IconAusdbcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#6tmqo__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#6tmqo__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#6tmqo__mzpez__clip0_298_901)">
          <path
            fill="#2151F4"
        ...
        <defs>
          <clipPath id="6tmqo__mzpez__clip0_298_901">
