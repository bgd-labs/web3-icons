...
const IconAusdbcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#1z2qs__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#1z2qs__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#1z2qs__b1qj4__clip0_298_901)">
          <path
            fill="#2151F4"
        ...
        <defs>
          <clipPath id="1z2qs__b1qj4__clip0_298_901">
