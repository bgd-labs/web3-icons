...
const IconAusdbcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#yg1ap__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#yg1ap__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#yg1ap__f7yje__clip0_298_901)">
          <path
            fill="#2151F4"
        ...
        <defs>
          <clipPath id="yg1ap__f7yje__clip0_298_901">
