...
const IconAusdbcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#jcx8m__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#jcx8m__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#jcx8m__iofpej__clip0_298_901)">
          <path
            fill="#2151F4"
        ...
        <defs>
          <clipPath id="jcx8m__iofpej__clip0_298_901">
