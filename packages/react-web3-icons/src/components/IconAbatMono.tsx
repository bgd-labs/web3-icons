...
const IconAbatMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#basicattentiontoken__circleClip)">
      <g
        style={{
