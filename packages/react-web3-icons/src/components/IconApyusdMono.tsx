...
const IconApyusdMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#apyusd__circleClip)">
      <g
        style={{
      ...
      >
        <g
          fill="currentColor"
          clipPath="url(#apyusd__paypalusd__clip0_298_734)"
        >
        ...
        <defs>
          <clipPath id="apyusd__paypalusd__clip0_298_734">
    ...
    <defs>
      <clipPath id="apyusd__circleClip">
