...
const IconApyusdMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#paypalusd__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#paypalusd__clip0_298_734)">
          ...
          <path d="M19.47 12.85c0-.52-.42-.94-.94-.94l-5.7-.02-.3 1.91h6.01c.52 0 .94-.42.94-.94z" />
        ...
        <defs>
          <clipPath id="paypalusd__clip0_298_734">
    ...
    <defs>
      <clipPath id="paypalusd__circleClip">
