...
const IconApyusdMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#byh1l__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#byh1l__lqkdt__clip0_298_734)">
        ...
        <defs>
          <clipPath id="byh1l__lqkdt__clip0_298_734">
