...
const IconApyusdMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#b03l6__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#b03l6__hp00v__clip0_298_734)">
        ...
        <defs>
          <clipPath id="b03l6__hp00v__clip0_298_734">
