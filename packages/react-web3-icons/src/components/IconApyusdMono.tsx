...
const IconApyusdMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#eoqhs__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#eoqhs__kw462l__clip0_298_734)">
        ...
        <defs>
          <clipPath id="eoqhs__kw462l__clip0_298_734">
