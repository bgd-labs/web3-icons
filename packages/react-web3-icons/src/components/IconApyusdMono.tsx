...
const IconApyusdMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#2rltu__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#2rltu__dw17h__clip0_298_734)">
        ...
        <defs>
          <clipPath id="2rltu__dw17h__clip0_298_734">
