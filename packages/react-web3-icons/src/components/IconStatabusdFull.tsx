...
const IconStatabusdFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statabusd__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statabusd__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statabusd__busd__clip0_292_114)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="statabusd__busd__clip0_292_114">
    ...
    <defs>
      <linearGradient
        id="statabusd__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statabusd__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatabusdFull;
