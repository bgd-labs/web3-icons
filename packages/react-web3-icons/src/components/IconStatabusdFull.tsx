...
const IconStatabusdFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#rhnic__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#rhnic__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#rhnic__pd7ck__clip0_292_114)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="rhnic__pd7ck__clip0_292_114">
