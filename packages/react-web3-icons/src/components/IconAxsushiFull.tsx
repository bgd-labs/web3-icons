...
const IconAxsushiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#pqvod__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#pqvod__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#pqvod__clip0_298_486)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="pqvod__clip0_298_486">
