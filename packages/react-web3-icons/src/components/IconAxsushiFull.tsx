...
const IconAxsushiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#sqds2__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#sqds2__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#sqds2__wmo9h__clip0_298_486)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="sqds2__wmo9h__clip0_298_486">
