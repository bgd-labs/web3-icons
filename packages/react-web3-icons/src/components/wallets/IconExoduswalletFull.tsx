...
const IconExoduswalletFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g mask="url(#hxsysg__e)">
      <path fill="url(#hxsysg__f)" d="M.875 0h224.25v230H.875z" />
    </g>
    <defs>
      <linearGradient
        id="hxsysg__a"
...
export default IconExoduswalletFull;
