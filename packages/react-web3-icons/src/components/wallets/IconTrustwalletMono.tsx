...
const IconTrustwalletMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="100%"
    height="100%"
    fill="none"
    className="trustwallet__mt-4 trustwallet__h-auto trustwallet__w-[180px]"
    viewBox="0 0 39 43"
    {...props}
  >
    <path
    ...
    />
    <path
      fill="url(#trustwallet__paint0_linear_524_7586892384)"
      d="M38.154 6.673 19.433.606v42c13.372-5.6 18.72-16.333 18.72-22.399z"
    />
    <defs>
      <linearGradient
        id="trustwallet__paint0_linear_524_7586892384"
        x1={33.181}
        x2={19.115}
        y1={-2.335}
        y2={42.056}
      ...
      >
        <stop offset={0.02} stopColor="currentColor" />
...
export default IconTrustwalletMono;
