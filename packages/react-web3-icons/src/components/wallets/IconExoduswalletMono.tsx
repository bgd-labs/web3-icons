...
const IconExoduswalletMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g mask="url(#b0w5cf__e)">
      <path fill="url(#b0w5cf__f)" d="M.875 0h224.25v230H.875z" />
    </g>
    <defs>
      <linearGradient
        id="b0w5cf__a"
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0.12} stopColor="currentColor" stopOpacity={0.87} />
        <stop offset={1} stopColor="currentColor" stopOpacity={0} />
      </linearGradient>
    </defs>
  </svg>
);
export default IconExoduswalletMono;
