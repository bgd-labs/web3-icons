...
const IconTokenpocketwalletMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M1041.52 0H-27v1024h1068.52z" />
    <g clipPath="url(#znhgj__a)">
      <path
        fill="currentColor"
      ...
      <path
        fill="#fff"
        d="M709.781 277c-102.959 0-186.532 83.573-186.532 186.533 0 88.551 61.697 162.692 144.484 181.817V463.533c0-23.186 18.863-42.049 42.048-42.049s42.049 18.863 42.049 42.049c0 19.518-13.23 35.892-31.307 40.607a41.7 41.7 0 0 1-10.742 1.441v144.485c3.668 0 7.205-.131 10.742-.262 97.982-5.633 175.791-86.848 175.791-186.271C896.445 360.573 812.872 277 709.781 277"
      />
      <path
        fill="#fff"
        d="M709.78 650.066V505.581c-1.047 0-1.964 0-3.012-.131v144.616z"
      />
    </g>
    <defs>
      <linearGradient
      ...
      <clipPath id="znhgj__a">
        <path fill="#fff" d="M168 277h728.448v470H168z" />
      </clipPath>
    </defs>
  </svg>
);
export default IconTokenpocketwalletMono;
