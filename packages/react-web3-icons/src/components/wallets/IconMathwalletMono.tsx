...
const IconMathwalletMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g mask="url(#o7de6__a)">
      <path fill="currentColor" d="M0 0h130v130H0z" />
      <mask
        id="o7de6__b"
        width={130}
        height={130}
      ...
      <g mask="url(#o7de6__b)">
        <g filter="url(#o7de6__c)">
          <path fill="url(#o7de6__d)" d="M0 0h130v130H0z" />
        </g>
        <path
          fill="#fff"
...
export default IconMathwalletMono;
