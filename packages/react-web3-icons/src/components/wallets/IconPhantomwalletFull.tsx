...
const IconPhantomwalletFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#phantomwallet__a)">
      <circle cx={64} cy={64} r={64} fill="url(#phantomwallet__b)" />
      <g filter="url(#phantomwallet__c)">
        <path
          fill="url(#phantomwallet__d)"
...
export default IconPhantomwalletFull;
