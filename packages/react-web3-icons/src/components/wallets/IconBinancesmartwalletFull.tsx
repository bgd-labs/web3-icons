...
const IconBinancesmartwalletFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#lmnv6i__clip0_292_152)">
      <path
        fill="#F0B90B"
        fillRule="evenodd"
    ...
    <defs>
      <clipPath id="lmnv6i__clip0_292_152">
        <path fill="#fff" d="M0 0h32v32H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default IconBinancesmartwalletFull;
