...
const IconStataosethMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#stataoseth__circleClip)">
      ...
      >
        <g clipPath="url(#stataoseth__stakedeth__clip0_298_1031)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="stataoseth__stakedeth__clip0_298_1031">
...
export default IconStataosethMono;
