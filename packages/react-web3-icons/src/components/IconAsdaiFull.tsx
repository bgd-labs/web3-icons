...
const IconAsdaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#56vca__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#56vca__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#56vca__vub37__clip0_298_392)">
          <path
            fill="url(#56vca__vub37__paint0_linear_298_392)"
        ...
        <defs>
          <linearGradient
            id="56vca__vub37__paint0_linear_298_392"
            x1={15.99}
            x2={15.99}
            y1={0}
            y2={32}
          ...
          <clipPath id="56vca__vub37__clip0_298_392">
