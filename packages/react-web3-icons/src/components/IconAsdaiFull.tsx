...
const IconAsdaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#savingsdai__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#savingsdai__circleClip)">
      ...
      >
        <g clipPath="url(#savingsdai__clip0_298_392)">
          <path
            fill="url(#savingsdai__paint0_linear_298_392)"
        ...
        <defs>
          <linearGradient
            id="savingsdai__paint0_linear_298_392"
            x1={15.99}
            x2={15.99}
            y1={0}
            y2={32}
          ...
          <clipPath id="savingsdai__clip0_298_392">
    ...
    <defs>
      <linearGradient
        id="savingsdai__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
