...
const IconStatamaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#maimimatic__paint0_linear_42_5)"
      fillRule="evenodd"
    ...
    <g clipPath="url(#maimimatic__circleClip)">
      ...
      >
        <g clipPath="url(#maimimatic__clip0_298_258)">
          <path
            fill="url(#maimimatic__paint0_linear_298_258)"
            d="M16 32c8.837 0 16-7.163 16-16S24.837 0 16 0 0 7.163 0 16s7.163 16 16 16"
          />
          <path
            stroke="url(#maimimatic__paint1_linear_298_258)"
        ...
        <defs>
          <linearGradient
            id="maimimatic__paint0_linear_298_258"
            x1={16.002}
            x2={16.002}
            y1={0.004}
            y2={32.004}
          ...
          <linearGradient
            id="maimimatic__paint1_linear_298_258"
            x1={16.002}
            x2={16.002}
            y1={2.756}
            y2={29.239}
    ...
    <defs>
      <linearGradient
        id="maimimatic__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
