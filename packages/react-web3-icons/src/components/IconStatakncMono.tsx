...
const IconStatakncMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#stataknc__circleClip)">
      ...
      >
        <g clipPath="url(#stataknc__kybernetworkcrystalv2__clip0_294_254)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="stataknc__kybernetworkcrystalv2__clip0_294_254">
...
export default IconStatakncMono;
