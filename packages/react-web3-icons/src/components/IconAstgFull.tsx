...
const IconAstgFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#8c9c__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#8c9c__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#8c9c__hg7qmf__clip0_298_1022)">
          <path
            fill="#000"
        ...
        <defs>
          <clipPath id="8c9c__hg7qmf__clip0_298_1022">
