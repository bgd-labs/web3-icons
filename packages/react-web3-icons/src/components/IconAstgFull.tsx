...
const IconAstgFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#7xcac__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#7xcac__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#7xcac__clip0_298_1022)">
          <path
            fill="#000"
        ...
        <defs>
          <clipPath id="7xcac__clip0_298_1022">
