...
const IconAstgFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#e3zjs__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#e3zjs__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#e3zjs__iyuh9__clip0_298_1022)">
          <path
            fill="#000"
        ...
        <defs>
          <clipPath id="e3zjs__iyuh9__clip0_298_1022">
