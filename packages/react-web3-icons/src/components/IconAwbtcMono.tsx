...
const IconAwbtcMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#qxvgzh__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#qxvgzh__q1ijhh__clip0_298_909)">
    ...
    <defs>
      <clipPath id="qxvgzh__circleClip">
