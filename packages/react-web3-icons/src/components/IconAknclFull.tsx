...
const IconAknclFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#h53ti__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#h53ti__circleClip)">
      <g
        style={{
    ...
    <defs>
      ...
      <clipPath id="h53ti__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconAknclFull;
