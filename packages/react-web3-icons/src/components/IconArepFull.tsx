...
const IconArepFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#9krt1__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#9krt1__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#9krt1__g1acmj__clip0_297_171)">
          <path
            fill="#fff"
