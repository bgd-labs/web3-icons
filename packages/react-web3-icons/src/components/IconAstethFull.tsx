...
const IconAstethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#asteth__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#asteth__circleClip)">
      ...
      >
        <g clipPath="url(#asteth__lidostakedether__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="asteth__lidostakedether__clip0_298_545">
    ...
    <defs>
      <linearGradient
        id="asteth__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
