...
const IconAstethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#64i4j__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#64i4j__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#64i4j__05bxr__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="64i4j__05bxr__clip0_298_545">
