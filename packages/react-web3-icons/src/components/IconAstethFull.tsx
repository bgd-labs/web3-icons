...
const IconAstethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#g9uek__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#g9uek__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#g9uek__cqcof__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="g9uek__cqcof__clip0_298_545">
