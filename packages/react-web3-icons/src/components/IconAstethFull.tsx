...
const IconAstethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#dwthq__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#dwthq__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#dwthq__uxrzg__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="dwthq__uxrzg__clip0_298_545">
