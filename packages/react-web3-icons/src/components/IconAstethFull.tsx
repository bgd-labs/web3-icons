...
const IconAstethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#oqmp2__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#oqmp2__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#oqmp2__n0qw4__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="oqmp2__n0qw4__clip0_298_545">
