...
const IconAenjFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#qugli__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#qugli__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#qugli__byj2dj__clip0_294_3414)">
          <path
            fill="#7567CD"
        ...
        <defs>
          <clipPath id="qugli__byj2dj__clip0_294_3414">
