...
const IconAenjFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#bulla__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#bulla__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#bulla__zfettj__clip0_294_3414)">
          <path
            fill="#7567CD"
        ...
        <defs>
          <clipPath id="bulla__zfettj__clip0_294_3414">
