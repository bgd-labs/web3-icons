...
const IconAenjFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#rs3ek__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#rs3ek__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#rs3ek__knpjv__clip0_294_3414)">
          <path
            fill="#7567CD"
        ...
        <defs>
          <clipPath id="rs3ek__knpjv__clip0_294_3414">
