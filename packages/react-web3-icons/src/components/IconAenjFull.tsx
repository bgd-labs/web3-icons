...
const IconAenjFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#17c6k__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#17c6k__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#17c6k__dqxbw__clip0_294_3414)">
          <path
            fill="#7567CD"
        ...
        <defs>
          <clipPath id="17c6k__dqxbw__clip0_294_3414">
