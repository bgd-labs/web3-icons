...
const IconAenjFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#yjhll__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#yjhll__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#yjhll__clip0_294_3414)">
          <path
            fill="#7567CD"
        ...
        <defs>
          <clipPath id="yjhll__clip0_294_3414">
