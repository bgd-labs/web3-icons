...
const IconAftmFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#dghs9__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#dghs9__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#dghs9__o2ykg__clip0_294_3389)">
          <path
            fill="#1969FF"
        ...
        <defs>
          <clipPath id="dghs9__o2ykg__clip0_294_3389">
    ...
    <defs>
      ...
      <clipPath id="dghs9__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconAftmFull;
