...
const IconAftmFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#aftm__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#aftm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#aftm__fantom__clip0_294_3389)">
          <path
            fill="#1969FF"
        ...
        <defs>
          <clipPath id="aftm__fantom__clip0_294_3389">
