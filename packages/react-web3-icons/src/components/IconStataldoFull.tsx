...
const IconStataldoFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#mspnbg__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#mspnbg__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#mspnbg__mlmm7__clip0_297_35)">
          <path
            fill="#F69988"
        ...
        <defs>
          <clipPath id="mspnbg__mlmm7__clip0_297_35">
    ...
    <defs>
      ...
      <clipPath id="mspnbg__circleClip">
