...
const IconStataldoFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#regzm__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#regzm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#regzm__clip0_297_35)">
          <path
            fill="#F69988"
        ...
        <defs>
          <clipPath id="regzm__clip0_297_35">
