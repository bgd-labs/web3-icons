...
const IconStataldoFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#stataldo__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataldo__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataldo__lidodaotoken__clip0_297_35)">
          <path
            fill="#F69988"
        ...
        <defs>
          <clipPath id="stataldo__lidodaotoken__clip0_297_35">
    ...
    <defs>
      <linearGradient
        id="stataldo__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataldo__circleClip">
