...
const IconAwbnbFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#wjy0a__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#wjy0a__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#wjy0a__675d6__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="wjy0a__675d6__clip0_292_152">
