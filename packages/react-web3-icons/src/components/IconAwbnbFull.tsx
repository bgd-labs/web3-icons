...
const IconAwbnbFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#do6z2__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#do6z2__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#do6z2__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="do6z2__clip0_292_152">
