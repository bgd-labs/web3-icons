...
const IconAwbnbFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#hklnuf__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#hklnuf__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#hklnuf__7spml__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="hklnuf__7spml__clip0_292_152">
    ...
    <defs>
      <linearGradient
        id="hklnuf__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="hklnuf__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconAwbnbFull;
