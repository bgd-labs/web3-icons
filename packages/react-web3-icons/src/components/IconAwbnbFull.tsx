...
const IconAwbnbFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#zq58l__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#zq58l__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#zq58l__pr94b__clip0_292_152)">
          <path
            fill="#F0B90B"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="zq58l__pr94b__clip0_292_152">
