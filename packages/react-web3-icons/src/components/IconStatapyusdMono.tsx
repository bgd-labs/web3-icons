...
const IconStatapyusdMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statapyusd__circleClip)">
      <g
        style={{
      ...
      >
        <g
          fill="currentColor"
          clipPath="url(#statapyusd__paypalusd__clip0_298_734)"
        >
        ...
        <defs>
          <clipPath id="statapyusd__paypalusd__clip0_298_734">
    ...
    <defs>
      <clipPath id="statapyusd__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatapyusdMono;
