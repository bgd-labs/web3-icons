...
const IconStataarbFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#stataarb__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataarb__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataarb__arbitrum__clip0_292_45)">
          <path
            fill="#213147"
        ...
        <defs>
          <clipPath id="stataarb__arbitrum__clip0_292_45">
    ...
    <defs>
      <linearGradient
        id="stataarb__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataarb__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStataarbFull;
