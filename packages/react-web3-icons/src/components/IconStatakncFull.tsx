...
const IconStatakncFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#stataknc__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataknc__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataknc__kybernetworkcrystalv2__clip0_294_256)">
          <path
            fill="#31CB9E"
        ...
        <defs>
          <clipPath id="stataknc__kybernetworkcrystalv2__clip0_294_256">
    ...
    <defs>
      <linearGradient
        id="stataknc__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataknc__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatakncFull;
