...
const IconAmaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#c2jkc__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#c2jkc__bem6f__clip0_298_256)">
        ...
        <defs>
          <clipPath id="c2jkc__bem6f__clip0_298_256">
