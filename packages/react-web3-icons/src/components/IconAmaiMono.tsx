...
const IconAmaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#qrjkn__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#qrjkn__1g5km__clip0_298_256)">
        ...
        <defs>
          <clipPath id="qrjkn__1g5km__clip0_298_256">
