...
const IconAmaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#5j11m__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#5j11m__zzxpg__clip0_298_256)">
        ...
        <defs>
          <clipPath id="5j11m__zzxpg__clip0_298_256">
