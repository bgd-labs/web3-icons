...
const IconAmaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#qhmn9__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#qhmn9__zjdn8i__clip0_298_256)">
        ...
        <defs>
          <clipPath id="qhmn9__zjdn8i__clip0_298_256">
