...
const IconAmaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#fgxrzg__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#fgxrzg__kgtv__clip0_298_256)">
        ...
        <defs>
          <clipPath id="fgxrzg__kgtv__clip0_298_256">
    ...
    <defs>
      <clipPath id="fgxrzg__circleClip">
