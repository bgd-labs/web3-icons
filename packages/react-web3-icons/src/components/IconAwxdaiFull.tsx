...
const IconAwxdaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#70uwb__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#70uwb__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#70uwb__vtqka__clip0_297_211)">
          <path
            fill="#12326C"
        ...
        <defs>
          <clipPath id="70uwb__vtqka__clip0_297_211">
