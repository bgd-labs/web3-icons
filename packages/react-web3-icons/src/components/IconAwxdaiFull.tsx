...
const IconAwxdaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#t6dcs__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#t6dcs__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#t6dcs__71nlh__clip0_297_211)">
          <path
            fill="#12326C"
        ...
        <defs>
          <clipPath id="t6dcs__71nlh__clip0_297_211">
