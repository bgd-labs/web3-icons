...
const IconAwxdaiFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#awxdai__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#awxdai__circleClip)">
      ...
      >
        <g clipPath="url(#awxdai__wrappedxdai__clip0_297_211)">
          <path
            fill="#12326C"
        ...
        <defs>
          <clipPath id="awxdai__wrappedxdai__clip0_297_211">
    ...
    <defs>
      <linearGradient
        id="awxdai__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
