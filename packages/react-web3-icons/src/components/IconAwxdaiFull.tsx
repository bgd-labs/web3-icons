...
const IconAwxdaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#l4usj__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#l4usj__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#l4usj__clip0_297_211)">
          <path
            fill="#12326C"
        ...
        <defs>
          <clipPath id="l4usj__clip0_297_211">
