...
const IconAwxdaiFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#vfwb5__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#vfwb5__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#vfwb5__15lz2l__clip0_297_211)">
          <path
            fill="#12326C"
        ...
        <defs>
          <clipPath id="vfwb5__15lz2l__clip0_297_211">
