...
const IconStatastmaticMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statastmatic__circleClip)">
      ...
      >
        <g clipPath="url(#statastmatic__stakedmaticpos__clip0_298_710)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statastmatic__stakedmaticpos__clip0_298_710">
...
export default IconStatastmaticMono;
