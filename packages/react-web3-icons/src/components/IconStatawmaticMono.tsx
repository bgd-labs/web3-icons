...
const IconStatawmaticMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statawmatic__circleClip)">
      ...
      >
        <g clipPath="url(#statawmatic__wrappedmatic__clip0_297_197)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statawmatic__wrappedmatic__clip0_297_197">
...
export default IconStatawmaticMono;
