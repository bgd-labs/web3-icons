...
const IconAeuraMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#fpxjz__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#fpxjz__2zz9sg__clip0_297_3)">
