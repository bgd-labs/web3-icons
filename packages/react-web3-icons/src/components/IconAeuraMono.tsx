...
const IconAeuraMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#ptrqs__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#ptrqs__3f9jk__clip0_297_3)">
        ...
        <defs>
          <clipPath id="ptrqs__3f9jk__clip0_297_3">
