...
const IconAeuraMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#k92lk__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#k92lk__p5ovv__clip0_297_3)">
        ...
        <defs>
          <clipPath id="k92lk__p5ovv__clip0_297_3">
