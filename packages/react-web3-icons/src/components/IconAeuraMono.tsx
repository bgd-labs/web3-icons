...
const IconAeuraMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#pwvge__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#pwvge__puyck__clip0_297_3)">
        ...
        <defs>
          <clipPath id="pwvge__puyck__clip0_297_3">
