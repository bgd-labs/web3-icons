...
const IconStatatusdFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statatusd__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statatusd__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statatusd__trueusd__clip0_297_141)">
          <path
            fill="#0C2764"
        ...
        <defs>
          <clipPath id="statatusd__trueusd__clip0_297_141">
    ...
    <defs>
      <linearGradient
        id="statatusd__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statatusd__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatatusdFull;
