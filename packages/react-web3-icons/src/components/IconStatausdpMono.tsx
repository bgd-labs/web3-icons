...
const IconStatausdpMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#y0sz1__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#y0sz1__oml3n__clip0_298_343)">
        ...
        <defs>
          <clipPath id="y0sz1__oml3n__clip0_298_343">
