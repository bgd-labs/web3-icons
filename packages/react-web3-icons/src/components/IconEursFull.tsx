...
const IconEursFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#afsx3__clip0_292_205)">
      <path
        fill="#fff"
        d="M16 32c8.837 0 16-7.163 16-16S24.837 0 16 0 0 7.163 0 16s7.163 16 16 16"
      />
      <path
        fill="url(#afsx3__paint0_linear_292_205)"
        fillRule="evenodd"
      ...
      />
      <path
        fill="url(#afsx3__paint1_linear_292_205)"
        fillRule="evenodd"
    ...
    <defs>
      <linearGradient
        id="afsx3__paint0_linear_292_205"
        x1={-9.525}
        x2={19.499}
        y1={33.514}
        y2={4.236}
      ...
      <linearGradient
        id="afsx3__paint1_linear_292_205"
        x1={3.6}
        x2={25.44}
        y1={25.34}
        y2={8.33}
      ...
      <clipPath id="afsx3__clip0_292_205">
