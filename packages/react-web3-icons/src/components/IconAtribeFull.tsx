...
const IconAtribeFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#re5yjk__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#re5yjk__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#re5yjk__hxtdu__clip0_298_930)">
          <path
            fill="#428AC9"
        ...
        <defs>
          <clipPath id="re5yjk__hxtdu__clip0_298_930">
    ...
    <defs>
      <linearGradient
        id="re5yjk__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="re5yjk__circleClip">
