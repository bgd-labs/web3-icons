...
const IconAtribeFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#zsibj__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#zsibj__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#zsibj__b6guq__clip0_298_930)">
          <path
            fill="#428AC9"
        ...
        <defs>
          <clipPath id="zsibj__b6guq__clip0_298_930">
