...
const IconAtribeFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#2ncpf__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#2ncpf__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#2ncpf__v4tss__clip0_298_930)">
          <path
            fill="#428AC9"
        ...
        <defs>
          <clipPath id="2ncpf__v4tss__clip0_298_930">
