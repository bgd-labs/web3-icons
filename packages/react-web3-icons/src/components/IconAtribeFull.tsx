...
const IconAtribeFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#q7fd9__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#q7fd9__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#q7fd9__1vnii__clip0_298_930)">
          <path
            fill="#428AC9"
        ...
        <defs>
          <clipPath id="q7fd9__1vnii__clip0_298_930">
