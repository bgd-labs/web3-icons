...
const IconAtribeFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#yhbwoj__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#yhbwoj__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#yhbwoj__clip0_298_930)">
          <path
            fill="#428AC9"
        ...
        <defs>
          <clipPath id="yhbwoj__clip0_298_930">
    ...
    <defs>
      <linearGradient
        id="yhbwoj__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="yhbwoj__circleClip">
