...
const IconAdpiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#bmc88__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#bmc88__l4i1hf__clip0_294_3750)">
          ...
          <path d="M16.852 12.162a7 7 0 0 1 2.073.287c.103.03.185.082.287.123a.2.2 0 0 0-.02-.072q-.385-.982-1.078-1.58a4.5 4.5 0 0 0-1.632-.893 7.4 7.4 0 0 0-2.021-.287h-2.29v10.13H14c.215 0 .41-.021.626-.042v-7.666h2.237z" />
        ...
        <defs>
          <clipPath id="bmc88__l4i1hf__clip0_294_3750">
