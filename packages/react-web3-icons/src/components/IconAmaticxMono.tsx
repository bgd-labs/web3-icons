...
const IconAmaticxMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#tm2hxi__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#tm2hxi__t2yk4__clip0_298_295)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="tm2hxi__t2yk4__clip0_298_295">
    ...
    <defs>
      <clipPath id="tm2hxi__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconAmaticxMono;
