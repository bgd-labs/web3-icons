...
const IconStatausdbcMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statausdbc__circleClip)">
      ...
      >
        <g clipPath="url(#statausdbc__usdbasecoin__clip0_298_899)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statausdbc__usdbasecoin__clip0_298_899">
...
export default IconStatausdbcMono;
