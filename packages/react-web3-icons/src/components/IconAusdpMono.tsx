...
const IconAusdpMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#iyao3__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#iyao3__oml3n__clip0_298_343)">
        ...
        <defs>
          <clipPath id="iyao3__oml3n__clip0_298_343">
