...
const IconAusdpMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#mv6bql__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#mv6bql__q2z7qh__clip0_298_343)">
        ...
        <defs>
          <clipPath id="mv6bql__q2z7qh__clip0_298_343">
    ...
    <defs>
      <clipPath id="mv6bql__circleClip">
