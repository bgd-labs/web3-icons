...
const IconAusdpMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#rqs9ll__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#rqs9ll__soljb__clip0_298_343)">
        ...
        <defs>
          <clipPath id="rqs9ll__soljb__clip0_298_343">
    ...
    <defs>
      <clipPath id="rqs9ll__circleClip">
