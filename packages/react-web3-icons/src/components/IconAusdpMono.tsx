...
const IconAusdpMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#brzav__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#brzav__vchn4__clip0_298_343)">
        ...
        <defs>
          <clipPath id="brzav__vchn4__clip0_298_343">
