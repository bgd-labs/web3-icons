...
const IconAusdpMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#hc2mk__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#hc2mk__y30ra__clip0_298_343)">
        ...
        <defs>
          <clipPath id="hc2mk__y30ra__clip0_298_343">
