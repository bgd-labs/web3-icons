...
const IconStmaticFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#stakedmatic(pos)__clip0_298_712)">
      <path
        fill="#fff"
        d="M16 0c8.84 0 16 7.16 16 16s-7.16 16-16 16S0 24.84 0 16 7.16 0 16 0"
      />
      <path
        fill="url(#stakedmatic(pos)__paint0_linear_298_712)"
    ...
    <defs>
      <linearGradient
        id="stakedmatic(pos)__paint0_linear_298_712"
        x1={27.22}
        x2={4.64}
        y1={7.62}
        y2={24.35}
      ...
      <clipPath id="stakedmatic(pos)__clip0_298_712">
        <path fill="#fff" d="M0 0h32v32H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default IconStmaticFull;
