...
const IconStatafdusdFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statafdusd__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statafdusd__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statafdusd__firstdigitalusd__clip0_294_284)">
          <path
            fill="#0B0E11"
        ...
        <defs>
          <clipPath id="statafdusd__firstdigitalusd__clip0_294_284">
    ...
    <defs>
      <linearGradient
        id="statafdusd__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statafdusd__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatafdusdFull;
