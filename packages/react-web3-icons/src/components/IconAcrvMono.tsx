...
const IconAcrvMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#curvedaotoken__circleClip)">
      ...
      >
        ...
        <path d="M12.39 17.01c-.61-.88-1.37-1.32-2.22-1.26-1.6.12-2.7 2.18-2.51 4.69.19 2.43 1.51 4.26 3.05 4.26h.15c.82-.06 1.53-.63 1.99-1.59.42-.86.6-1.96.51-3.11-.09-1.14-.44-2.2-.98-2.99zm-.55 5.59c-.28.57-.66.92-1.06.95-.82.07-1.83-1.24-1.98-3.2-.15-1.97.65-3.41 1.46-3.47h.06c.38 0 .79.28 1.14.78.43.61.71 1.5.78 2.43s-.07 1.85-.4 2.52z" />
      </g>
    </g>
    <defs>
