...
const IconStatarenMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#stataren__circleClip)">
      ...
      >
        <g clipPath="url(#stataren__republictoken__clip0_298_748)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="stataren__republictoken__clip0_298_748">
...
export default IconStatarenMono;
