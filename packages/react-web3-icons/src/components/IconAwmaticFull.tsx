...
const IconAwmaticFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#sbb8ki__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#sbb8ki__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#sbb8ki__clip0_297_199)">
          <path
            fill="#fff"
            d="M16 32c8.84 0 16-7.16 16-16S24.84 0 16 0 0 7.16 0 16s7.16 16 16 16"
          />
          <path
            fill="url(#sbb8ki__paint0_linear_297_199)"
        ...
        <defs>
          <linearGradient
            id="sbb8ki__paint0_linear_297_199"
            x1={6.7}
            x2={25.96}
            y1={22.78}
            y2={8.74}
          ...
          <clipPath id="sbb8ki__clip0_297_199">
    ...
    <defs>
      <linearGradient
        id="sbb8ki__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="sbb8ki__circleClip">
