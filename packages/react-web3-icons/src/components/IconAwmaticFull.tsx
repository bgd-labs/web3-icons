...
const IconAwmaticFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#1cgvs__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#1cgvs__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#1cgvs__y6y7f__clip0_297_199)">
          <path
            fill="#fff"
            d="M16 32c8.84 0 16-7.16 16-16S24.84 0 16 0 0 7.16 0 16s7.16 16 16 16"
          />
          <path
            fill="url(#1cgvs__y6y7f__paint0_linear_297_199)"
        ...
        <defs>
          <linearGradient
            id="1cgvs__y6y7f__paint0_linear_297_199"
            x1={6.7}
            x2={25.96}
            y1={22.78}
            y2={8.74}
          ...
          <clipPath id="1cgvs__y6y7f__clip0_297_199">
