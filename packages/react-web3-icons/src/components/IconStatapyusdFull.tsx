...
const IconStatapyusdFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statapyusd__paint0_linear_42_5)"
      fillRule="evenodd"
    ...
    <g clipPath="url(#statapyusd__circleClip)">
      ...
      >
        <g clipPath="url(#statapyusd__paypalusd__clip0_298_736)">
          <path
            fill="#306FEA"
        ...
        <defs>
          <clipPath id="statapyusd__paypalusd__clip0_298_736">
    ...
    <defs>
      <linearGradient
        id="statapyusd__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
...
export default IconStatapyusdFull;
