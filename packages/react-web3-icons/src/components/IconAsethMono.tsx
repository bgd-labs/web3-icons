...
const IconAsethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#qzauei__circleClip)">
      <g
        fill="currentColor"
        style={{
      ...
      >
        <path d="M13.51 17.05h-.87l-2.87 4.02h3.74c1.11 0 2.01-.91 2.01-2.02s-.9-2-2.01-2.01zm-1.67-1.57 2.87-4.02h-3.67c-1.11 0-2.01.91-2.01 2.02s.9 2 2.01 2.01h.79z" />
    ...
    <defs>
      <clipPath id="qzauei__circleClip">
