...
const IconStatamanaMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#yespe__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#yespe__tckrv__clip0_297_227)">
        ...
        <defs>
          <clipPath id="yespe__tckrv__clip0_297_227">
