...
const IconStatamanaMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statamana__circleClip)">
      ...
      >
        <g
          fill="currentColor"
          clipPath="url(#statamana__decentraland__clip0_297_227)"
        >
        ...
        <defs>
          <clipPath id="statamana__decentraland__clip0_297_227">
...
export default IconStatamanaMono;
