...
const IconStatamanaMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#ghu6r__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#ghu6r__12ohz__clip0_297_227)">
        ...
        <defs>
          <clipPath id="ghu6r__12ohz__clip0_297_227">
