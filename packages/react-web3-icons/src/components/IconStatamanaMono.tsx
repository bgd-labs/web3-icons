...
const IconStatamanaMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#ifgxd__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#ifgxd__1vfgr__clip0_297_227)">
        ...
        <defs>
          <clipPath id="ifgxd__1vfgr__clip0_297_227">
