...
const IconStatasdaiFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statasdai__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statasdai__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statasdai__savingsdai__clip0_298_392)">
          <path
            fill="url(#statasdai__savingsdai__paint0_linear_298_392)"
        ...
        <defs>
          <linearGradient
            id="statasdai__savingsdai__paint0_linear_298_392"
            x1={15.99}
            x2={15.99}
            y1={0}
            y2={32}
          ...
          <clipPath id="statasdai__savingsdai__clip0_298_392">
    ...
    <defs>
      <linearGradient
        id="statasdai__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statasdai__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatasdaiFull;
