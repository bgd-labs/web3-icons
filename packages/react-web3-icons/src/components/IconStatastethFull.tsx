...
const IconStatastethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#v7qjzk__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#v7qjzk__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#v7qjzk__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="v7qjzk__clip0_298_545">
    ...
    <defs>
      ...
      <clipPath id="v7qjzk__circleClip">
