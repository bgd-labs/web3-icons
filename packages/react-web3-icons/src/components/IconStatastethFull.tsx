...
const IconStatastethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#statasteth__paint0_linear_42_5)"
      fillRule="evenodd"
    ...
    <g clipPath="url(#statasteth__circleClip)">
      ...
      >
        <g clipPath="url(#statasteth__lidostakedether__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="statasteth__lidostakedether__clip0_298_545">
    ...
    <defs>
      <linearGradient
        id="statasteth__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
