...
const IconStatastethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#bes59h__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#bes59h__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#bes59h__05bxr__clip0_298_545)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="bes59h__05bxr__clip0_298_545">
    ...
    <defs>
      ...
      <clipPath id="bes59h__circleClip">
