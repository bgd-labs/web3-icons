...
const IconStataxsushiFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#stataxsushi__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataxsushi__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataxsushi__sushibar__clip0_298_486)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="stataxsushi__sushibar__clip0_298_486">
    ...
    <defs>
      <linearGradient
        id="stataxsushi__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataxsushi__circleClip">
