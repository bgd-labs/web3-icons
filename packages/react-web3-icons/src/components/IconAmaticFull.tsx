...
const IconAmaticFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#8qxze__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#8qxze__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#8qxze__e8jbe__clip0_298_364)">
          <path
            fill="url(#8qxze__e8jbe__paint0_linear_298_364)"
        ...
        <defs>
          <linearGradient
            id="8qxze__e8jbe__paint0_linear_298_364"
            x1={0.1}
            x2={24.13}
            y1={6.27}
            y2={20.98}
          ...
          <clipPath id="8qxze__e8jbe__clip0_298_364">
