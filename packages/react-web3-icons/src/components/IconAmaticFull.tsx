...
const IconAmaticFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#jy7cij__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#jy7cij__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#jy7cij__wqb6jg__clip0_298_364)">
          <path
            fill="url(#jy7cij__wqb6jg__paint0_linear_298_364)"
        ...
        <defs>
          <linearGradient
            id="jy7cij__wqb6jg__paint0_linear_298_364"
            x1={0.1}
            x2={24.13}
            y1={6.27}
            y2={20.98}
          ...
          <clipPath id="jy7cij__wqb6jg__clip0_298_364">
    ...
    <defs>
      <linearGradient
        id="jy7cij__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="jy7cij__circleClip">
