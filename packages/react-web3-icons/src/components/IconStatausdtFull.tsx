...
const IconStatausdtFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#y3b1ti__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#y3b1ti__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#y3b1ti__vc8i4j__clip0_298_873)">
          <path
            fill="#509E7D"
        ...
        <defs>
          <clipPath id="y3b1ti__vc8i4j__clip0_298_873">
    ...
    <defs>
      ...
      <clipPath id="y3b1ti__circleClip">
