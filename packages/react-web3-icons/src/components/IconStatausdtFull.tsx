...
const IconStatausdtFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statausdt__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statausdt__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statausdt__tether__clip0_298_873)">
          <path
            fill="#509E7D"
        ...
        <defs>
          <clipPath id="statausdt__tether__clip0_298_873">
    ...
    <defs>
      <linearGradient
        id="statausdt__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statausdt__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatausdtFull;
