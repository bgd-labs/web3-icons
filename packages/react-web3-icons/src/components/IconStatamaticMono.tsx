...
const IconStatamaticMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statamatic__circleClip)">
      ...
      >
        <g clipPath="url(#statamatic__polygon__clip0_298_362)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statamatic__polygon__clip0_298_362">
...
export default IconStatamaticMono;
