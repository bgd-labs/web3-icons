...
const IconStatarenFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#stataren__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataren__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataren__republictoken__clip0_298_750)">
          <path
            fill="#183055"
        ...
        <defs>
          <clipPath id="stataren__republictoken__clip0_298_750">
    ...
    <defs>
      <linearGradient
        id="stataren__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataren__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatarenFull;
