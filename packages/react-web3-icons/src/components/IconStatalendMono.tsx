...
const IconStatalendMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statalend__circleClip)">
      ...
      >
        <g clipPath="url(#statalend__aave[old]__clip0_297_20)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statalend__aave[old]__clip0_297_20">
...
export default IconStatalendMono;
