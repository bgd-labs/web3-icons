...
const IconAavaxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#a9396__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#a9396__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#a9396__clip0_292_172)">
          <path
            fill="#E84142"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="a9396__clip0_292_172">
