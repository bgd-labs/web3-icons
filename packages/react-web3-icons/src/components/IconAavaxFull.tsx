...
const IconAavaxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#avalanche__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#avalanche__circleClip)">
      <g
        style={{
    ...
    <defs>
      <linearGradient
        id="avalanche__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="avalanche__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconAavaxFull;
