...
const IconAsteurFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#asteur__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#asteur__circleClip)">
      <g
        style={{
      ...
      >
        ...
        <defs>
          <linearGradient
            id="asteur__anglestakedeura__paint0_linear_165_88"
            x1={2.85}
            x2={29.89}
            y1={14.14}
            y2={18.16}
          ...
          >
            <stop stopColor="#F7F0E7" />
            <stop offset={1} stopColor="#6B90F6" />
          </linearGradient>
          <linearGradient
            id="asteur__anglestakedeura__paint1_linear_165_88"
            x1={12.94}
            x2={20.92}
            y1={12.42}
            y2={27.35}
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.07} stopColor="#AEC2F7" />
            <stop offset={1} stopColor="#7F9EF4" />
          </linearGradient>
          <linearGradient
            id="asteur__anglestakedeura__paint2_linear_165_88"
            x1={19.91}
            x2={23.12}
            y1={8.3}
            y2={5.46}
    ...
    <defs>
      <linearGradient
        id="asteur__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="asteur__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconAsteurFull;
