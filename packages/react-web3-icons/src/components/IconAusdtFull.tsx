...
const IconAusdtFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#65evc__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#65evc__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#65evc__hrpvr__clip0_298_873)">
          <path
            fill="#509E7D"
        ...
        <defs>
          <clipPath id="65evc__hrpvr__clip0_298_873">
