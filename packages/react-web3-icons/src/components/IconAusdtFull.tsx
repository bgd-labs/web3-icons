...
const IconAusdtFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#hudoth__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#hudoth__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#hudoth__clip0_298_873)">
          <path
            fill="#509E7D"
        ...
        <defs>
          <clipPath id="hudoth__clip0_298_873">
    ...
    <defs>
      <linearGradient
        id="hudoth__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="hudoth__circleClip">
