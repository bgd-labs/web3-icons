...
const IconAusdtFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#ausdt__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#ausdt__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#ausdt__tether__clip0_298_873)">
          <path
            fill="#509E7D"
        ...
        <defs>
          <clipPath id="ausdt__tether__clip0_298_873">
