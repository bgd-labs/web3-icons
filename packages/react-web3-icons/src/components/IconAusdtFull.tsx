...
const IconAusdtFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#mobrq__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#mobrq__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#mobrq__xue9f__clip0_298_873)">
          <path
            fill="#509E7D"
        ...
        <defs>
          <clipPath id="mobrq__xue9f__clip0_298_873">
