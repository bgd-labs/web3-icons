...
const IconAusdtFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#qzfvl__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#qzfvl__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#qzfvl__p3gkm__clip0_298_873)">
          <path
            fill="#509E7D"
        ...
        <defs>
          <clipPath id="qzfvl__p3gkm__clip0_298_873">
