...
const IconAusdcMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#nwm9d__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#nwm9d__vm87o__clip0_298_783)">
        ...
        <defs>
          <clipPath id="nwm9d__vm87o__clip0_298_783">
