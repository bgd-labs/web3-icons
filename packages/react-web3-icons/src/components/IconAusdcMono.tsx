...
const IconAusdcMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#vosm1__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#vosm1__hltd3__clip0_298_783)">
        ...
        <defs>
          <clipPath id="vosm1__hltd3__clip0_298_783">
