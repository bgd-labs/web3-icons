...
const IconAarbMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#fs5x4__circleClip)">
      <g
        fill="currentColor"
        style={{
