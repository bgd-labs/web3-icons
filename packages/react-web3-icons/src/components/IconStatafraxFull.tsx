...
const IconStatafraxFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statafrax__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statafrax__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statafrax__frax__clip0_294_3448)">
          <path
            fill="#000"
        ...
        <defs>
          <clipPath id="statafrax__frax__clip0_294_3448">
    ...
    <defs>
      <linearGradient
        id="statafrax__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statafrax__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatafraxFull;
