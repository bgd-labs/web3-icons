...
const IconAeuraFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#q83nd__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#q83nd__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#q83nd__dcf5ng__clip0_297_5)">
          <path
            fill="url(#q83nd__dcf5ng__paint0_linear_297_5)"
        ...
        <defs>
          <linearGradient
            id="q83nd__dcf5ng__paint0_linear_297_5"
            x1={16}
            x2={16}
            y1={0}
            y2={32}
          ...
          <clipPath id="q83nd__dcf5ng__clip0_297_5">
