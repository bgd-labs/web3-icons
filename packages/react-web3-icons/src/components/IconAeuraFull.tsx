...
const IconAeuraFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#n2t2z__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#n2t2z__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#n2t2z__6g9mo__clip0_297_5)">
          <path
            fill="url(#n2t2z__6g9mo__paint0_linear_297_5)"
        ...
        <defs>
          <linearGradient
            id="n2t2z__6g9mo__paint0_linear_297_5"
            x1={16}
            x2={16}
            y1={0}
            y2={32}
          ...
          <clipPath id="n2t2z__6g9mo__clip0_297_5">
