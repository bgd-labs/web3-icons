...
const IconAeuraFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#yryzyl__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#yryzyl__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#yryzyl__cgeny__clip0_297_5)">
          <path
            fill="url(#yryzyl__cgeny__paint0_linear_297_5)"
        ...
        <defs>
          <linearGradient
            id="yryzyl__cgeny__paint0_linear_297_5"
            x1={16}
            x2={16}
            y1={0}
            y2={32}
          ...
          <clipPath id="yryzyl__cgeny__clip0_297_5">
    ...
    <defs>
      <linearGradient
        id="yryzyl__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="yryzyl__circleClip">
