...
const IconAeuraFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#eura(ageur)__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#eura(ageur)__circleClip)">
      ...
      >
        <g clipPath="url(#eura(ageur)__eura(ageur)__clip0_297_5)">
          <path
            fill="url(#eura(ageur)__eura(ageur)__paint0_linear_297_5)"
    ...
    <defs>
      <linearGradient
        id="eura(ageur)__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
