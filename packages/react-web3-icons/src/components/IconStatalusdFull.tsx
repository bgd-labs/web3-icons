...
const IconStatalusdFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statalusd__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statalusd__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statalusd__lusdstablecoin__clip0_297_185)">
          <path
            fill="#705ED6"
    ...
    <defs>
      <linearGradient
        id="statalusd__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statalusd__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatalusdFull;
