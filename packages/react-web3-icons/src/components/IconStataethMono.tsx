...
const IconStataethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#4gmppf__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#4gmppf__k7jrnh__clip0_294_3461)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="4gmppf__k7jrnh__clip0_294_3461">
    ...
    <defs>
      <clipPath id="4gmppf__circleClip">
