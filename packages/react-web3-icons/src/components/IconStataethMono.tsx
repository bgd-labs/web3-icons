...
const IconStataethMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#stataeth__circleClip)">
      ...
      >
        <g clipPath="url(#stataeth__ethereum__clip0_294_3461)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="stataeth__ethereum__clip0_294_3461">
...
export default IconStataethMono;
