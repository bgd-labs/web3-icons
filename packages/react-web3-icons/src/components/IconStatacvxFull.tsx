...
const IconStatacvxFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#kqfrs__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#kqfrs__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#kqfrs__clip0_294_266)">
          <path
            fill="#fff"
            d="M16 32c8.837 0 16-7.163 16-16S24.837 0 16 0 0 7.163 0 16s7.163 16 16 16"
          />
          <path
            fill="url(#kqfrs__paint0_linear_294_266)"
        ...
        <defs>
          <linearGradient
            id="kqfrs__paint0_linear_294_266"
            x1={24.031}
            x2={10.449}
            y1={6.358}
            y2={32.882}
          ...
          <clipPath id="kqfrs__clip0_294_266">
