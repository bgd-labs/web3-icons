...
const IconStatacvxFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statacvx__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statacvx__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statacvx__convextoken__clip0_294_266)">
          <path
            fill="#fff"
            d="M16 32c8.837 0 16-7.163 16-16S24.837 0 16 0 0 7.163 0 16s7.163 16 16 16"
          />
          <path
            fill="url(#statacvx__convextoken__paint0_linear_294_266)"
        ...
        <defs>
          <linearGradient
            id="statacvx__convextoken__paint0_linear_294_266"
            x1={24.031}
            x2={10.449}
            y1={6.358}
            y2={32.882}
          ...
          <clipPath id="statacvx__convextoken__clip0_294_266">
    ...
    <defs>
      <linearGradient
        id="statacvx__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statacvx__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatacvxFull;
