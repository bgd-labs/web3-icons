...
const IconStataethFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#stataeth__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#stataeth__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stataeth__ethereum__clip0_294_3463)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="stataeth__ethereum__clip0_294_3463">
    ...
    <defs>
      <linearGradient
        id="stataeth__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="stataeth__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStataethFull;
