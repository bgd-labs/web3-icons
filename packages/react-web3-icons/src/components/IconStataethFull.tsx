...
const IconStataethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#5pbnn__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#5pbnn__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#5pbnn__clip0_294_3463)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="5pbnn__clip0_294_3463">
