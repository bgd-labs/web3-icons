...
const IconApyusdFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#h8zui__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#h8zui__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#h8zui__12wzz__clip0_298_736)">
          <path
            fill="#306FEA"
        ...
        <defs>
          <clipPath id="h8zui__12wzz__clip0_298_736">
