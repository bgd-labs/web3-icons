...
const IconApyusdFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#6uk2s__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#6uk2s__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#6uk2s__2mjtf__clip0_298_736)">
          <path
            fill="#306FEA"
        ...
        <defs>
          <clipPath id="6uk2s__2mjtf__clip0_298_736">
