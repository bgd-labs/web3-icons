...
const IconApyusdFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#bgmg3f__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#bgmg3f__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#bgmg3f__clip0_298_736)">
          <path
            fill="#306FEA"
        ...
        <defs>
          <clipPath id="bgmg3f__clip0_298_736">
    ...
    <defs>
      <linearGradient
        id="bgmg3f__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="bgmg3f__circleClip">
