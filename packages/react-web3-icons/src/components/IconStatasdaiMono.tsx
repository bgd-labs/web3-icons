...
const IconStatasdaiMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#q1gdg__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#q1gdg__741ag__clip0_298_390)">
        ...
        <defs>
          <clipPath id="q1gdg__741ag__clip0_298_390">
