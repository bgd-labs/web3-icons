...
const IconAusdcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#sf4j4__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#sf4j4__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#sf4j4__clip0_298_785)">
          <path
            fill="#3E73C2"
        ...
        <defs>
          <clipPath id="sf4j4__clip0_298_785">
