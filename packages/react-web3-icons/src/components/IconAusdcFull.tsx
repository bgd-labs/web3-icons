...
const IconAusdcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#6yypn__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#6yypn__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#6yypn__0ed54l__clip0_298_785)">
          <path
            fill="#3E73C2"
        ...
        <defs>
          <clipPath id="6yypn__0ed54l__clip0_298_785">
