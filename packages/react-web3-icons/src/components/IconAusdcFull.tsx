...
const IconAusdcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#jyadq__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#jyadq__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#jyadq__mz9nw__clip0_298_785)">
          <path
            fill="#3E73C2"
        ...
        <defs>
          <clipPath id="jyadq__mz9nw__clip0_298_785">
