...
const IconAusdcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#fqjx8__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#fqjx8__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#fqjx8__ou8mx__clip0_298_785)">
          <path
            fill="#3E73C2"
        ...
        <defs>
          <clipPath id="fqjx8__ou8mx__clip0_298_785">
