...
const IconAusdcFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#ausdc__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#ausdc__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#ausdc__usdcoin__clip0_298_785)">
          <path
            fill="#3E73C2"
        ...
        <defs>
          <clipPath id="ausdc__usdcoin__clip0_298_785">
