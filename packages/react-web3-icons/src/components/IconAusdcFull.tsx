...
const IconAusdcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#vjigx__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#vjigx__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#vjigx__ipz9r__clip0_298_785)">
          <path
            fill="#3E73C2"
        ...
        <defs>
          <clipPath id="vjigx__ipz9r__clip0_298_785">
