...
const IconAusdcFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#zdfvm__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#zdfvm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#zdfvm__13r71__clip0_298_785)">
          <path
            fill="#3E73C2"
        ...
        <defs>
          <clipPath id="zdfvm__13r71__clip0_298_785">
