...
const IconMaiMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill="currentColor" clipPath="url(#mai(mimatic)__clip0_298_256)">
    ...
    <defs>
      <clipPath id="mai(mimatic)__clip0_298_256">
        <path fill="#fff" d="M0 0h32v32H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default IconMaiMono;
