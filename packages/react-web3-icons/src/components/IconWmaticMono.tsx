...
const IconWmaticMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#wrappedmatic__clip0_297_197)">
      <path
        fill="currentColor"
    ...
    <defs>
      <clipPath id="wrappedmatic__clip0_297_197">
        <path fill="#fff" d="M0 0h32v32H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default IconWmaticMono;
