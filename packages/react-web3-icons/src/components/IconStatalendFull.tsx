...
const IconStatalendFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#statalend__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statalend__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statalend__aave[old]__clip0_297_24)">
          <path
            fill="url(#statalend__aave[old]__paint0_linear_297_24)"
        ...
        <defs>
          <linearGradient
            id="statalend__aave[old]__paint0_linear_297_24"
            x1={0}
            x2={32}
            y1={16}
            y2={16}
          ...
          <clipPath id="statalend__aave[old]__clip0_297_24">
    ...
    <defs>
      <linearGradient
        id="statalend__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statalend__circleClip">
