...
const IconStatajeurFull = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="url(#statajeur__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statajeur__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statajeur__jarvissyntheticeuro__clip0_294_241)">
          <path
            fill="#FC0"
        ...
        <defs>
          <clipPath id="statajeur__jarvissyntheticeuro__clip0_294_241">
    ...
    <defs>
      <linearGradient
        id="statajeur__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statajeur__circleClip">
        <circle cx={16} cy={16} r={13} />
      </clipPath>
    </defs>
  </svg>
);
export default IconStatajeurFull;
