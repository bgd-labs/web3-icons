...
const IconAstmaticFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#stakedmaticpos__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#stakedmaticpos__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stakedmaticpos__clip0_298_712)">
          <path
            fill="#fff"
            d="M16 0c8.84 0 16 7.16 16 16s-7.16 16-16 16S0 24.84 0 16 7.16 0 16 0"
          />
          <path
            fill="url(#stakedmaticpos__paint0_linear_298_712)"
        ...
        <defs>
          <linearGradient
            id="stakedmaticpos__paint0_linear_298_712"
            x1={27.22}
            x2={4.64}
            y1={7.62}
            y2={24.35}
    ...
    <defs>
      <linearGradient
        id="stakedmaticpos__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
