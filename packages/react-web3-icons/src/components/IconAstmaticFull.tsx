...
const IconAstmaticFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#stakedmatic(pos)__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#stakedmatic(pos)__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#stakedmatic(pos)__stakedmatic(pos)__clip0_298_712)">
          <path
            fill="#fff"
            d="M16 0c8.84 0 16 7.16 16 16s-7.16 16-16 16S0 24.84 0 16 7.16 0 16 0"
          />
          <path
            fill="url(#stakedmatic(pos)__stakedmatic(pos)__paint0_linear_298_712)"
    ...
    <defs>
      <linearGradient
        id="stakedmatic(pos)__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
