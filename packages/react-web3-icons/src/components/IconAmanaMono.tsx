...
const IconAmanaMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#yiu5c__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#yiu5c__1vfgr__clip0_297_227)">
        ...
        <defs>
          <clipPath id="yiu5c__1vfgr__clip0_297_227">
