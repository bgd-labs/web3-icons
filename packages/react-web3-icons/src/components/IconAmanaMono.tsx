...
const IconAmanaMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#79ajt__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#79ajt__vzem3__clip0_297_227)">
        ...
        <defs>
          <clipPath id="79ajt__vzem3__clip0_297_227">
