...
const IconAmanaMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#jnkp4__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#jnkp4__tckrv__clip0_297_227)">
        ...
        <defs>
          <clipPath id="jnkp4__tckrv__clip0_297_227">
