...
const IconAwethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#n7rxr__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#n7rxr__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#n7rxr__1dmfv__clip0_298_454)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="n7rxr__1dmfv__clip0_298_454">
