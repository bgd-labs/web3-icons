...
const IconAwethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#szhbz__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#szhbz__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#szhbz__s2zq2__clip0_298_454)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="szhbz__s2zq2__clip0_298_454">
