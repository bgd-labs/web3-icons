...
const IconAwethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#xj3ji__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#xj3ji__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#xj3ji__clip0_298_454)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="xj3ji__clip0_298_454">
