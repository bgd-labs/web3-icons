...
const IconAwethFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#w2exz__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#w2exz__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#w2exz__thnbt__clip0_298_454)">
          <path
            fill="#fff"
        ...
        <defs>
          <clipPath id="w2exz__thnbt__clip0_298_454">
