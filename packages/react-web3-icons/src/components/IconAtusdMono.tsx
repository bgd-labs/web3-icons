...
const IconAtusdMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#4b3agk__circleClip)">
      <g
        fill="currentColor"
        style={{
