...
const IconStatausdtMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    <g clipPath="url(#statausdt__circleClip)">
      ...
      >
        <g
          fill="currentColor"
          fillRule="evenodd"
          clipPath="url(#statausdt__tether__clip0_298_871)"
          clipRule="evenodd"
        >
        ...
        <defs>
          <clipPath id="statausdt__tether__clip0_298_871">
...
export default IconStatausdtMono;
