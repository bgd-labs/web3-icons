...
const IconStatastethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#fae8kg__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#fae8kg__nrkzf__clip0_298_543)">
        ...
        <defs>
          <clipPath id="fae8kg__nrkzf__clip0_298_543">
    ...
    <defs>
      <clipPath id="fae8kg__circleClip">
