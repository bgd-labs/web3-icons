...
const IconStatastethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statasteth__circleClip)">
      <g
        style={{
      ...
      >
        <g
          fill="currentColor"
          clipPath="url(#statasteth__lidostakedether__clip0_298_543)"
        >
        ...
        <defs>
          <clipPath id="statasteth__lidostakedether__clip0_298_543">
    ...
    <defs>
      <clipPath id="statasteth__circleClip">
