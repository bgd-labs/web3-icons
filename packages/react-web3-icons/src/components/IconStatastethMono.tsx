...
const IconStatastethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#60d3cg__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#60d3cg__clip0_298_543)">
        ...
        <defs>
          <clipPath id="60d3cg__clip0_298_543">
    ...
    <defs>
      <clipPath id="60d3cg__circleClip">
