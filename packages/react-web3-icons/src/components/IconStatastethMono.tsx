...
const IconStatastethMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#ageb5l__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#ageb5l__jq5bp__clip0_298_543)">
        ...
        <defs>
          <clipPath id="ageb5l__jq5bp__clip0_298_543">
    ...
    <defs>
      <clipPath id="ageb5l__circleClip">
