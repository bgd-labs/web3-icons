...
const IconStatamkrMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statamkr__circleClip)">
      ...
      >
        <g clipPath="url(#statamkr__maker__clip0_298_617)">
          <path
            fill="currentColor"
            fillRule="evenodd"
        ...
        <defs>
          <clipPath id="statamkr__maker__clip0_298_617">
...
export default IconStatamkrMono;
