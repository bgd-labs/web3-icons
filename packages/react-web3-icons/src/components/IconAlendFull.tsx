...
const IconAlendFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#ayygm__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#ayygm__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#ayygm__clip0_297_24)">
          <path
            fill="url(#ayygm__paint0_linear_297_24)"
        ...
        <defs>
          <linearGradient
            id="ayygm__paint0_linear_297_24"
            x1={0}
            x2={32}
            y1={16}
            y2={16}
          ...
          <clipPath id="ayygm__clip0_297_24">
