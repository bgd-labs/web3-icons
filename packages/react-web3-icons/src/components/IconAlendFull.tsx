...
const IconAlendFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#aave[old]__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#aave[old]__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#aave[old]__clip0_297_24)">
          <path
            fill="url(#aave[old]__paint0_linear_297_24)"
        ...
        <defs>
          <linearGradient
            id="aave[old]__paint0_linear_297_24"
            x1={0}
            x2={32}
            y1={16}
            y2={16}
          ...
          <clipPath id="aave[old]__clip0_297_24">
    ...
    <defs>
      <linearGradient
        id="aave[old]__paint0_linear_40_91"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="aave[old]__circleClip">
