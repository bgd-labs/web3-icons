...
const IconAlendFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <circle
      ...
      cy={16}
      r={15}
      stroke="url(#alend__paint0_linear_40_91)"
      strokeWidth={2}
    />
    <g clipPath="url(#alend__circleClip)">
      ...
      >
        <g clipPath="url(#alend__aave[old]__clip0_297_24)">
          <path
            fill="url(#alend__aave[old]__paint0_linear_297_24)"
        ...
        <defs>
          <linearGradient
            id="alend__aave[old]__paint0_linear_297_24"
            x1={0}
            x2={32}
            y1={16}
            y2={16}
          ...
          <clipPath id="alend__aave[old]__clip0_297_24">
