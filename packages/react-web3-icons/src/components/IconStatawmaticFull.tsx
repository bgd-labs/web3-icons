...
const IconStatawmaticFull = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="url(#statawmatic__paint0_linear_42_5)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <g clipPath="url(#statawmatic__circleClip)">
      <g
        style={{
      ...
      >
        <g clipPath="url(#statawmatic__wrappedmatic__clip0_297_199)">
          <path
            fill="#fff"
            d="M16 32c8.84 0 16-7.16 16-16S24.84 0 16 0 0 7.16 0 16s7.16 16 16 16"
          />
          <path
            fill="url(#statawmatic__wrappedmatic__paint0_linear_297_199)"
        ...
        <defs>
          <linearGradient
            id="statawmatic__wrappedmatic__paint0_linear_297_199"
            x1={6.7}
            x2={25.96}
            y1={22.78}
            y2={8.74}
          ...
          <clipPath id="statawmatic__wrappedmatic__clip0_297_199">
    ...
    <defs>
      <linearGradient
        id="statawmatic__paint0_linear_42_5"
        x1={26.976}
        x2={6.592}
        y1={4.32}
        y2={28.352}
      ...
      <clipPath id="statawmatic__circleClip">
