...
const IconAldoMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#fbftll__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#fbftll__33sf__clip0_297_32)">
        ...
        <defs>
          <clipPath id="fbftll__33sf__clip0_297_32">
    ...
    <defs>
      <clipPath id="fbftll__circleClip">
