...
const IconAldoMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#j5atpj__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#j5atpj__352ge__clip0_297_32)">
        ...
        <defs>
          <clipPath id="j5atpj__352ge__clip0_297_32">
    ...
    <defs>
      <clipPath id="j5atpj__circleClip">
