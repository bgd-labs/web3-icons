...
const IconAldoMono = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g clipPath="url(#7q0te__circleClip)">
      <g
        style={{
      ...
      >
        <g fill="currentColor" clipPath="url(#7q0te__ftqhd__clip0_297_32)">
        ...
        <defs>
          <clipPath id="7q0te__ftqhd__clip0_297_32">
