...
const IconStatatribeMono = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#statatribe__circleClip)">
      ...
      >
        <g clipPath="url(#statatribe__tribe__clip0_298_928)">
          <path
            fill="currentColor"
        ...
        <defs>
          <clipPath id="statatribe__tribe__clip0_298_928">
...
export default IconStatatribeMono;
